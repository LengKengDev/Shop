    ...
    <div class="container">
        ...
        <div class="col-md-9">
            <div class="box">
                ...
                <p class="text-muted">If you have any questions, please feel free to <a href="{{route('pages.contact')}}">contact us</a>, our customer service center is working for you 24/7.</p>
