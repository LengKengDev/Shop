        ...
        <div class="col-sm-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">{{__("Create new tag")}}</h3>
                                ...
                                <div class="row">
                                    <div class="col-sm-5">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  placeholder="name tag" type="text"  value="{{ old('name') }}"
                                                   name="name" required>
                                            @if ($errors->has('name'))
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  placeholder="title tag" type="text"  value="{{ old('title') }}"
                                                   name="title">
                                            @if ($errors->has('title'))
                                                <span class="invalid-feedback text-danger" role="alert">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control"  placeholder="Độ ưu tiên" type="number"  value="{{ old('position', 1) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="show_on_home" required>
                                                <option value="1">Hiện</option>
                                                <option value="0">Ẩn</option>
                                            </select> Show on home page
                                            <hr>

                                            <select name="show_on_product" required>
                                                <option value="1">Hiện</option>
                                                <option value="0">Ẩn</option>
