                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-right">{{ __('Họ và tên') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="tel" class="col-md-4 col-form-label text-right">{{ __('Số điện thoại') }}</label>
